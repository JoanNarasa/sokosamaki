          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-product/'.$productDetails->id)}}" name="edit_product" id="edit_product" novalidate="novalidate">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="category_id" id="category_id" width="228px">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    ...
                    @if(!empty($productDetails->image))
                      <img  style="width:70px;" src="{{ asset('/images/backend_images/products/small/'.$productDetails->image) }}" alt=""> | <a href="{{ url('/admin/delete-product-image/'.$productDetails->id)}}">Delete</a>
                    @endif
                </div>
            </div>
